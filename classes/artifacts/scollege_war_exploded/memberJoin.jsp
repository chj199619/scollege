...
<div id="middle">
	<div id="list">
		 ...
		 <div class="list_info">
		 	 ...
		 	 <input type="hidden" name="paramsMember.user.user_id" id="paramsMember.user.user_id" value='${userFront.user_id}'/>
		     <input type="hidden" name="paramsMember.college.college_id" id="paramsMember.college.college_id" value='<s:property value="#attr.college.college_id"/>'/>
