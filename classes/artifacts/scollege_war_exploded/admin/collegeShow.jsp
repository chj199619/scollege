...
function serch()
{
   document.info.action="Admin_listColleges.action";
...
function del()
{
    ...
    if(confirm('确认删除吗!?'))
    {
       document.info.action="Admin_delColleges.action?paramsCollege.ids="+ids;
       document.info.submit();
    }
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">社团管理&gt;&gt;社团查询</span>
</div>
<form name="info" id="info" action="Admin_listColleges.action" method="post">
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center"><s:property value="#college.user.real_name"/></td>
     ...
     <td width="" align="center">
       <img src="images/edit.png"/>&nbsp;<s:a href="Admin_editCollege.action?paramsCollege.college_id=%{#college.college_id}">编辑</s:a>
     </td>
   </tr> 
   </s:iterator>
   </s:if>
   <s:else>
   <tr>
     <td height="60" colspan="9" align="center"><b>&lt;不存在社团信息&gt;</b></td>
   </tr>
   </s:else>
