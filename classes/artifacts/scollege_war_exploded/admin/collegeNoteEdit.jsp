...
$(document).ready(function(){
	...
	$("#editBtn").bind('click',function(){
			...
			$("#info").attr('action','Admin_saveCollegeNote.action').submit();
...
<form id="info" name="info" action="Admin_saveCollegeNote.action" method="post">    
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        ...
        <tr>
          ...
          <td>
            <s:property value="#attr.college.user.real_name"/> 
          </td>  
        </tr> 
        <tr>
