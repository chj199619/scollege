...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   <tr class="listtitle">
     ...
     <td width="120" align="center">初步规划</td>
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center"><s:property value="#college.college_planShow"/></td>
     <td width="" align="center"><s:property value="#college.college_flagDesc"/></td>
     <td width="" align="center">
     <s:if test="#college.college_flag==1">
       <img src="images/edit.png"/>&nbsp;<s:a href="Admin_approveCollege.action?paramsCollege.college_id=%{#college.college_id}&paramsCollege.user.user_id=%{#college.user.user_id}">审批通过</s:a>
     </s:if>
     </td>
   </tr> 
   </s:iterator>
